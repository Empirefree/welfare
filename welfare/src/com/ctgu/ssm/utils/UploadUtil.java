...
public class UploadUtil {
	...
	public static String getUploadBasePath() {
		...
		if (os.toLowerCase().startsWith("win")) {
			basePath = "e:/welfare/upload/";
//			basePath = "./uploadImg/";
		} else {
			basePath = "/home/welfare/upload/";
		}
	 ...
	 * @return 生成文件保存路径
	 */
	public static String getFilePath(String fileDir, String path) {
		String filePath = getUploadBasePath() + fileDir;
