						...
						<div class="row product_row">
							...
							<div class="">
								<div class="product_content">
									<div class="product_name"><img src="${pwd}/upload/${help.actimg}" alt=""
											style="display:block;width:300px;margin:0 auto;"></div>
									<div class="product_text">
										<p style="text-indent:2em">${help.introduce}
										</p>
									</div>
									<!-- Product Size -->
						    ...
						    <div class="modal-dialog">
						        <div class="modal-content">
						            <div class="modal-header">
						                ...
						                <h4 class="modal-title" id="myModalLabel">捐赠</h4>
						            </div>
						            <div class="modal-body">
						            	 <form action="${pwd }/user/alipay3" method="post" class="form-horizontal">
											   <div class="form-group">
											    <label for="lastname" class="col-md-2 control-label">金额</label>
											    <div class="col-md-7">
											    	<input type="text" class="form-control" name="money" id="money" check="checkNum(this)"  placeholder="请输入要捐赠的金额">
											    	<input type="hidden" class="form-control" name="id" id="id" value = "${help.id }">
											    </div>
								...
								<div class="reviews">
									...
									<div class="row">
										<div class="col-md-8 col-md-offset-2">
											<form action="${pwd }/user/helppl" class="form" method="POST" id="addComment">
												<div class="form-group row">
													<div class="col-md-8">
														<input type="hidden"  name="itemid" id = "itemid" class="form-control" value = "${help.id }">
