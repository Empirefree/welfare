	 ...
	 <%@ include file="../baseFrame/userHead.jsp"%>
			<div class="contentRight">
				<h2 class="conTtile c mt_55">
					<span class="conTtile_name"><i class="conTtile_ico"></i>求助活动</span>
				</h2>
				<div class="contentText pb_67">
					<ul class="listCon ml_34 pt_10">
						
						<c:forEach items="${list}" var="act" varStatus="stat">
							<li class="c"><i class="i-point"></i><em><a href="${pwd }/user/helpDetial?id=${act.id}"> ${act.name}   </a></em><span> ${act.starttime } </span></li>
						</c:forEach>  
