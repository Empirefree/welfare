	...
	<section class="layui-larry-box">
		<div class="larry-personal">
			...
			<div class="larry-personal-body clearfix">
				<form class="layui-form col-lg-5" action="${pwd }/admin/offinfo/updateOffinfo" method="post">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="userid" check="checkNotEmpty(this)" autocomplete="off"
								class="layui-input" value="${offinfo.userid }">
						</div>
					</div>
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="name" check="checkNotEmpty(this)" autocomplete="off"
								class="layui-input" value="${offinfo.name }">
						</div>
					</div>
					<div class="layui-form-item">
						<label class="layui-form-label">活动介绍</label>
						<div class="layui-input-block">
							<textarea placeholder="" value="${offinfo.introduce }" check="checkNotEmpty(this)" name="introduce"
								class="layui-textarea">${offinfo.introduce }</textarea>
						</div>
					</div>
					<div class="layui-form-item">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="starttime" check="checkNotEmpty(this)" autocomplete="off"
								class="layui-input" value="${offinfo.starttime }">
						</div>
					</div>
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="endtime" check="checkNotEmpty(this)" autocomplete="off"
								class="layui-input" value="${offinfo.endtime }">
						</div>
					</div>
					<div class="layui-form-item">
						<div class="layui-input-block">
