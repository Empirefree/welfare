	...
	<section class="layui-larry-box">
		<div class="larry-personal">
			...
			<div class="larry-personal-body clearfix">
				<form class="layui-form col-lg-5" action="${pwd }/admin/user/updateUser" method="post">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="username" autocomplete="off" class="layui-input"
								value="${user.username }" check="checkNotEmpty(this)">
						</div>
					</div>
					<div class="layui-form-item">
						<label class="layui-form-label">密码</label>
						<div class="layui-input-block">
							<input type="text" name="password" check="checkNotEmpty(this)" autocomplete="off" class="layui-input" value="${user.password }">
						</div>
					</div>
					<div class="layui-form-item">
						<label class="layui-form-label">姓名</label>
						<div class="layui-input-block">
								<input type="text" name="actualname" check="checkNotEmpty(this)" autocomplete="off" class="layui-input" value="${user.actualname }">
						</div>
					</div>
					<!-- <div class="layui-form-item">
